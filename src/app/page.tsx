...
const supabaseUrl = 'https://suteltgngsaodsveqgaz.supabase.co';
...
function LinkCard({ data }: { data: { id: number; created_at: string; link: string; category: string | null } }) {
    ...
    <Card className="h-full hover:shadow-md transition-shadow">
      <CardContent>
        <div className="flex items-start gap-3">
          <div className="mt-1">{getLinkIcon(data.link)}</div>
